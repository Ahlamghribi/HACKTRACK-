...
const SavedEventsSection = () => {
  ...
  const filters = ['All', 'Now Running', 'Upcoming', 'Archive', 'Location', 'Team Members'];
  ...
  return (
    <div className="p-8 bg-[#1A232E] min-h-screen">
       <h1 className="text-white font-['Necosmic'] text-3xl mt-12 mb-12 text-center">
        ...
        <span className="text-purple-400">AHLAM</span>
    ...
    <div className="min-h-screen bg-[#1A232E] relative">
      <nav className="flex justify-between items-center px-30 py-16 bg-transparent ml-12">
        <div className="flex space-x-32 items-center">
          <Link to="/hackathons" className="text-purple-400 font-['Necosmic'] hover:text-purple-300">
            HACKATHONS
          </Link>
          <Link to="/ctfs" className="text-purple-400 font-['Necosmic'] hover:text-purple-300">
            CTFS
          </Link>
          <Link to="/">
            <img 
          ...
          <Link to="/datathons" className="text-purple-400 font-['Necosmic'] hover:text-purple-300">
            DATATHONS
          </Link><Link to="/" className="flex items-center space-x-2">
  <span className="text-white font-['Necosmic'] text-[22px]">Hello,</span>
  <span className="text-purple-400 font-['Necosmic'] text-[22px]">AHLAM</span>
</Link>
